    ...
    <main className="mx-auto max-w-7xl px-6">
      <section className="mt-8 rounded-3xl bg-gradient-to-br from-[hsl(var(--offwhite))] to-[hsl(var(--rose))]/10 p-6">
        ...
        <div className="mb-4 flex items-center gap-2">
          {["anxiety", "career", "relationships", "study"].map((t) => (
            <button
              key={t}
        ...
        <div className="mb-4 rounded-2xl border border-[hsl(var(--grayblue))] bg-white p-4">
          <textarea
            className="h-24 w-full rounded-xl border border-[hsl(var(--grayblue))] bg-white p-3 text-sm"
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {[1, 2, 3, 4].map((i) => (
            <Card key={i}>
              <CardBody>
                <div className="mb-2 flex items-center gap-2 text-sm text-[hsl(var(--charcoal))]/70">
                  <span className="grid h-8 w-8 place-items-center rounded-full bg-[hsl(var(--beige))]">
                    A
                  </span>{" "}
                  Anonymous
                </div>
                <p className="text-sm text-[hsl(var(--charcoal))]">
                  Today I practiced a short breathing session and felt calmer.
                </p>
